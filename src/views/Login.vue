<template>
	<h1 class="text-center text-3xl">Sign In to an account</h1>
	<div class="form w-1/3 mt-20 mx-auto">
		<input class="block" type="text" placeholder="Email" v-model="email" />
		...
		<div class="pass mt-3 relative">
			<div class="absolute cursor-pointer top-2/4 -translate-y-2/4 right-3" @click="showPassword = !showPassword">
				<svg v-if="!showPassword" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
					<path
