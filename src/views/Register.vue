<template>
	<h1 class="text-center text-zinc-200 text-3xl">Create an account</h1>
	...
	<div class="form max-w-[340px] mt-20 mx-auto">
		...
		<div class="pass relative mt-3">
			<div class="absolute fill-zinc-200 cursor-pointer top-2/4 -translate-y-2/4 right-3" @click="showPassword = !showPassword">
