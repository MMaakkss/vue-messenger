<template>
	<div class="w-1/2 m-auto">
		<div class="flex gap-3 items-center mb-3">
			...
			<div class="btn flex-1" @click="createNewChat">Create New Chat</div>
		</div>
		<div class="flex gap-3 items-center mb-3">
			<input class="flex-1" type="text" placeholder="Enter chat's id" v-model="joinChatId" />
			<div class="btn flex-1" @click="joinChat">Join Chat</div>
		</div>
		<div class="relative mb-4">
			<input type="text" placeholder="Search chat" v-model="search" />
			<svg class="absolute top-2/4 -translate-y-2/4 right-3" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M384 208A176 176 0 1 0 32 208a176 176 0 1 0 352 0zM343.3 366C307 397.2 259.7 416 208 416C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208c0 51.7-18.8 99-50 135.3L507.3 484.7c6.2 6.2 6.2 16.4 0 22.6s-16.4 6.2-22.6 0L343.3 366z"/></svg>
		</div>
		<div class="text-center" v-if="!chatsOutput.length">
...
import { collection, addDoc, onSnapshot, query, orderBy, getFirestore, updateDoc, doc, arrayUnion } from "firebase/firestore";
